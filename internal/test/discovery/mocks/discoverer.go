...
// IsTokenContainedInAnotherRange provides a mock function with given fields: token
func (_m *Discoverer) IsTokenContainedInAnotherRange(token types.Token) bool {
	ret := _m.Called(token)
